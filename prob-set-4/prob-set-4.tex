...
\begin{equation}
F\left(X_1, X_2 \right)=F_{X_1}\left(x_1 \right)F_{X_2}\left(x_2\right).
\end{equation}

$F \left(X_1, X_2\right)$ is the cdf of $X_1$, and $X_2$.  
$F_{X_1}\left(x_1 \right)$, and $F_{X_2}\left( x_2 \right)$ are the marginal 
cumulative distribution functions of $F\left( X, Y \right)$. 
...
\begin{equation}
F\left(X_1, X_2 \right)= e^{\lambda \left(x_1 + x_2}.
\end{equation}

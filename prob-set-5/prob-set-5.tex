...
The prior predictive probability of flipping heads is the same as the
Bayes denomenator $\frac{25}{50}=\frac{1}{2}$; it is the total probability of 
flipping heads without any data.  Therefore the prior predeictive probabiltiy 
...
we refer to the Bayes table in the previous section. The prior predictive
probability that the coin is a 0.3 coin is $\frac{3}{25}$.  By definition, the
posterior predictive probability that the coin is a 0.3 coin is the product
of the posterior probability we calculate in the Bayes table above and the
probability of the 0.3 coin landing on heads.  This is 
$\frac{3}{25}\left(\frac{3}{10}\right) = \frac{9}{250}$.
\printbibliography{}

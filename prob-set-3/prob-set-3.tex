...
Now we can use property 1 of the expected value of random variables
\cite{reading4a}, and the definition of expected value to obtain the expected
value of our profit or loss playing the game.

...
We rely on \cite{reading4a} to state that $P\left( C_{b} \right) = 0.5$,
and $P\left( C_{g} \right) = 0.5$.
...
We write one cell in the table below for each possible
...
\begin{center}
  \begin{tabular}{ | c | c | c |  }
    \hline
	C_{b}C_{b}C_{b} & C_{b}C_{b}C_{g} & C_{b}C_{g}C_{b} & C_{b}C_{g}C_{g}   \\ \hline
    	C_{g}C_{b}C_{b} & C_{g}C_{b}C_{g} & C_{g}C_{g}C_{b} & C_{g}C_{g}C_{g}   \\ \hline
  \end{tabular}
\end{center}

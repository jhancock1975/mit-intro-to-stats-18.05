...
\begin{equation}
  \text{Var}\left(X\right)=int_0^1 x3\left(x^2-1\right)^2 \,dx.
\end{equation}

Now we multiply the factors in the polynomial in the integral above
to get

\begin{equation}
  \text{Var}\left(X\right)=int_0^1 \left(3x^5-6x^3+3x\right) \,dx.
\end{equation}

Now we replace the integral above with its anti-derivative:

\begin{equation}
  \text{Var}\left(X\right)= \frac{3x^6}{6}-\frac{6x^4}{4}+\frac{3x^2}{2} \bigg\rvert_0^1
\end{equation}

And, we evaluate the anti-derivative over  the intervale $\left[0, 1\right]$:


\begin{equation}
  \text{Var}\left(X\right)= \frac{3}{6}-\frac{6}{4}+\frac{3}{2}
    =\frac{1}{2} + \frac{3}{2}+\frac{3}{2}=3\frac{1}{2}.
\end{equation}

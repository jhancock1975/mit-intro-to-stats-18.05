...
\node[end, label=] {}
    child {
        ...
        child {
          node[bag] {$N \cap C$}
          edge from parent node[above] {$P \left( N \mid C \right) = 1$}
        }
        child {
          node[bag] {$S \cap C$}
          edge from parent node[above]  { $P \left( S \mid C \right) =  0$}
        }
    ...
    child {
        ...
        child {
          node[bag] {$N \cap G$}
          edge from parent node[above] {$P \left( N \mid G \right) = 0$}
        }
        child {
          node[bag] {$S \cap G$}
          edge from parent node[above]  {$ P \left( S \mid G \right) = 1$}
        }
